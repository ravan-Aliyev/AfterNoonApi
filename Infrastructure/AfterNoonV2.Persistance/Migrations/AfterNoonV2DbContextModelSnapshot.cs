...
namespace AfterNoonV2.Persistance.Migrations
{
    ...
    partial class AfterNoonV2DbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AfterNoonV2.Domain.Entities.Enpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AfterNoonV2.Domain.Entities.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AppRoleEnpoint", b =>
                {
                    b.Property<Guid>("EnpointsId")
                        .HasColumnType("uuid");

                    b.Property<string>("RolesId")
                        .HasColumnType("text");

                    b.HasKey("EnpointsId", "RolesId");

                    b.HasIndex("RolesId");

                    b.ToTable("AppRoleEnpoint");
                });
            ...
            modelBuilder.Entity("AfterNoonV2.Domain.Entities.Enpoint", b =>
                {
                    b.HasOne("AfterNoonV2.Domain.Entities.Menu", "Menu")
                        .WithMany("Enpoints")
            ...
            modelBuilder.Entity("AfterNoonV2.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasOne("AfterNoonV2.Domain.Entities.Basket", "Basket")
                        .WithOne("Order")
                        .HasForeignKey("AfterNoonV2.Domain.Entities.Order", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AppRoleEnpoint", b =>
                {
                    b.HasOne("AfterNoonV2.Domain.Entities.Enpoint", null)
                        .WithMany()
                        .HasForeignKey("EnpointsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
